...
try {
    const b2gKunde = { name: 'Stadt Frankfurt', customer_type: 'B2G', adresse: 'Römerberg 1', plz: '60311', ort: 'Frankfurt am Main', leitweg_id: '992-88776655-15', buyer_reference: 'REF-8877' };
    const b2gInvoice = { id: 10, nr: 'RE-2026-B2G-002', status: 'Festgeschrieben', isLocked: true, datum: '2026-08-01', faellig: '2026-08-31', me: 1, netto: 15000, steuer: 2850, brutto: 17850, positionen: [{ name: 'Kanalbau', menge: 100, preis: 150, mwst: 19 }] };
